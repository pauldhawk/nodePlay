...
$white:    #fff;
$gray-100: #f8f8f8; // was $gray7
$gray-150: #F0F0F1; // started in reports
$gray-200: #e5e5e5; // was $gray6
$gray-300: #dddddd; // was $gray5
$gray-400: #cccccc; // was $gray4
$gray-450: #bbbbbb; // added as a half-step on 2018-08-26
$gray-500: #ababab; // was $gray3
$gray-600: #999999; // was $gray2
$gray-700: #707070; // was $gray1
$gray-800: #505050; // was $gray0
$gray-900: #303030;
$black:    #000;
...
$blue-light:         #0077bf; //#7590BC;
$blue-dark:          #0066a3; //#0066a3;
$blue-sky:           #3CA7E6; //for graphs!
$blue-pale:          #56AADB;
...
$primary-dark:       #273953; //#2d466f;
$primary:            #0066A3;
$primary-light:      #F2F6FA;
$primary-mid:        $blue-light; //#7590BC;
$primary-mid-light:  #afc6ec;

$accent:             $green-dark;  //#81AC48;
$accent-light:       $green-light; //#B5D190;
$accent-extra-light: $green_extra-light;
...
$underline-color: $gray-300; //#dddddd;
...
$colors: (
  ...
  gray:               $gray-600,
  gray-dark:          $gray-800,
  blue-super-light:   $blue-super-light,
  blue-extra-light:   $blue-extra-light,
  blue-light:         $blue-light,
  blue-dark:          $blue-dark,
  teal-extra-light:   $teal-extra-light,
  teal-light:         $teal-light,
  teal-dark:          $teal-dark,
  violet-extra-light: $violet-extra-light,
  violet-light:       $violet-light,
  violet-dark:        $violet-dark,
  green-extra-light:  $green-extra-light,
  green-light:        $green-light,
  green-dark:         $green-dark,
  orange-extra-light: $orange-extra-light,
  orange-light:       $orange-light,
  orange-dark:        $orange-dark,
  red-extra-light:    $red-extra-light,
  red-light:          $red-light,
  red-dark:           $red-dark,
  highlight-green:    $highlight-green,
  highlight-teal:     $highlight-teal
);
...
$theme-colors: (
  ...
  mid-light:    $gray-100,
  dark:         $gray-800,
  // AVIA colors after this line
  accent:             $accent,
  accent-light:       $accent-light,
  accent-extra-light: $accent-extra-light,
  black:              $black,
  blue-dark:          $blue-dark,
  blue-light:         $blue-light,
  blue-extra-light:   $blue-extra-light,
  ...
  primary-mid-light:  $primary-mid-light,
  red-dark:           $red-dark,
  red-light:          $red-light,
  red-extra-light:    $red-extra-light,
  teal-dark:          $teal-dark,
...
// Google Roboto font and Material Icons
...
@font-face {
  ...
  src: url("/assets/fonts/CenturyGothicStd.ttf")  format("truetype"),
       url("/assets/fonts/CenturyGothicStd.eot")  format("eot"),
       url("/assets/fonts/CenturyGothicStd.svg")  format("svg"),
       url("/assets/fonts/CenturyGothicStd.woff") format("woff"),
       url("/assets/fonts/CenturyGothicStd.otf")  format("otf")
}

@font-face {
  font-family: "CenturyGothicBld";
  src: url("/assets/fonts/CenturyGothicStd-Bold.ttf")  format("truetype"),
       url("/assets/fonts/CenturyGothicStd-Bold.eot")  format("eot"),
       url("/assets/fonts/CenturyGothicStd-Bold.svg")  format("svg"),
       url("/assets/fonts/CenturyGothicStd-Bold.woff") format("woff"),
       url("/assets/fonts/CenturyGothicStd-Bold.otf")  format("otf")
}

@font-face {
  font-family: "BLOKK";
  src: url("/assets/fonts/BLOKKNeue-Regular.ttf")  format("truetype"),
       url("/assets/fonts/BLOKKNeue-Regular.eot")  format("eot"),
       url("/assets/fonts/BLOKKNeue-Regular.svg")  format("svg"),
       url("/assets/fonts/BLOKKNeue-Regular.woff") format("woff"),
       url("/assets/fonts/BLOKKNeue-Regular.otf")  format("otf")
}
$fonttype_avia: "CenturyGothicStd", "Helvetica", "Arial", "sans-serif";
$fonttype_avia_large: "proxima-nova", "Helvetica", "Arial", "sans-serif";
$fonttype_aviaconnect: "Roboto", "Helvetica Neue", "Arial", "sans-serif";
$fonttype_poppins: "Poppins", "Helvetica Neue", "Arial", "sans-serif";


$font-family-sans-serif: $fonttype_aviaconnect;
// $font-family-monospace:  "SFMono-Regular", Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;
$font-family-base:       $fonttype_aviaconnect;

$font-size-base: 0.875rem; // Assumes the browser default, typically 16px
$font-size-xl:   1.250rem;
$font-size-lg:   1.000rem;
$font-size-sm:   0.750rem;
$font-size-xs:   0.500rem;
...
$headings-font-family:   $fonttype_avia_large;
...
$btn-focus-box-shadow:  none;          // 0 0 0 3px rgba(theme-color("primary"), .25);
$btn-active-box-shadow: none;          // inset 0 3px 5px rgba($black,.125);
...
$badge-pill-border-radius:    0.1875rem;
...
$list-group-item-padding-x:      $spacer * 1.25;
